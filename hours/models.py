...
light_colors = [('#ff9896', 'Red'), ('#f7b6d2', 'Pink'), ('#c5b0d5', 'Purple'), ('#68d8fd', 'Blue'), ('#9edae5', 'Cyan'), ('#98df8a', 'Green'), ('#dbdb8d', 'Olive'), ('#f5ff66', 'Yellow'), ('#c49c94', 'Brown'), ('#ffbb78', 'Orange')]
...
class Note(models.Model):
	...
	category = models.CharField(max_length=20, choices=(('success', 'سبز'), ('info', 'آبی'), ('warning', 'زرد'), ('danger', 'قرمز')))
	date = models.DateField()
